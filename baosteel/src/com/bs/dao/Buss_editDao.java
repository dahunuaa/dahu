...
public class Buss_editDao {
	...
	private String buss_id;
	 ...
	 public Buss_editDao(String buss_id,String buss_editor,String buss_editor_name,String bussmen_name,String buss_accounts,String buss_place,String buss_reason,String buss_begintime,String buss_endtime){
	 ...
	 public void buss_edit(){
         ...
         sb.append("UPDATE bussinessrecords SET editor=?,editor_name=?,bussmen_name=?,accounts=?,buss_place=?,buss_reason=?,buss_begintime=?,buss_endtime=?");
         sb.append(" WHERE bussinessrecords.`buss_id`=?");
	     PreparedStatement pstmt = null;
//	     System.out.println(bussmen_name);
//		 System.out.println(buss_editor);
//	     System.out.println(buss_accounts);
//	     System.out.println(buss_place);
//	     System.out.println(buss_reason);
//	     System.out.println(buss_begintime);
//	     System.out.println(buss_endtime);
	     try {
